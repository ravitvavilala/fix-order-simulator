...
| FR-22 | FIX 4.2 logon, fills, replace statuses, HandlInst, version mismatch, unsupported versions, reason codes, message types, cross-version trading, TWAP, translation rules; 4.4 still needs no HandlInst | `test_fix42.py::test_logon_with_fix42_is_answered_in_fix42`, `test_fills_are_reported_with_fix42_exec_types_and_exec_trans_type`, `test_replace_of_an_unfilled_order_reports_ord_status_replaced`, `test_replace_of_a_partly_filled_order_keeps_ord_status_partially_filled`, `test_order_without_handl_inst_is_rejected_on_fix42`, `test_handl_inst_outside_1_to_3_is_rejected_on_fix42`, `test_fix44_session_does_not_require_handl_inst`, `test_a_message_in_another_fix_version_ends_the_session`, `test_fix42_translation_rules`, `test_reason_codes_fix42_does_not_define_go_out_as_broker_option`, `test_message_types_added_after_fix42_get_a_session_reject_on_fix42`, `test_logon_with_an_unsupported_begin_string_is_closed_without_reply`, `test_each_client_gets_its_own_fix_version_when_they_trade_with_each_other`, `test_twap_slices_reach_a_fix42_session_in_fix42` |
